...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
			<p class="commentheader"><?php if(function_exists('get_avatar')) { echo get_avatar($comment, '40'); } ?>
			...
			<span class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?> at <?php comment_time() ?></a> <?php edit_comment_link('edit','&nbsp;&nbsp;',''); ?></span></p>
...
<p><textarea name="comment" id="comment" tabindex="4"></textarea><br/>
