...
function insert_social($content) {
  $twitter_status = urlencode(the_title()) . "%20" . metamark(get_permalink()) . "%20";
  $social = <<<SOCIAL
  <hr />
  <p class="social"><a title="Tweet this" href="http://twitter.com/home?status=$twitter_status" target="_blank"><img src="http://www.leancrew.com/all-this/images/twitter-share.png" /></a>
	<a href="http://delicious.com/save?url=<?php urlencode(the_permalink()); ?>&amp;title=<?php urlencode(the_title()); ?>" onclick="window.open('http://delicious.com/save?v=5&amp;noui&amp;jump=close&amp;url=<?php urlencode(the_permalink()); ?>&amp;title=<?php urlencode(the_title()); ?>', 'delicious', 'toolbar=no,width=550,height=550'); return false;" title="Bookmark on Delicious"><img src="http://www.leancrew.com/all-this/images/delicious-share.png" /></a>
	<a href="http://digg.com/submit?url=<?php the_permalink(); ?>&title=<?php the_title(); ?>" rel="nofollow" title="Share via Digg" target="_blank"><img src="http://www.leancrew.com/all-this/images/digg-share.png" /></a>
	<a href="http://reddit.com/submit?url=<?php the_permalink(); ?>" rel="nofollow" title="Share via Reddit" target="_blank"><img src="http://www.leancrew.com/all-this/images/reddit-share.png" /></a>
	<a href="http://www.stumbleupon.com/submit?url=<?php the_permalink(); ?>&title=<?php the_title(); ?>" rel="nofollow" title="Share via StumbleUpon" target="_blank"><img src="http://www.leancrew.com/all-this/images/stumbleupon-share.png" /></a></p>
SOCIAL;
...
// add_filter('the_excerpt_rss', 'insert_social');
// add_filter('the_content', 'insert_social');
